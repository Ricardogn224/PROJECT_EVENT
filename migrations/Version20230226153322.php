 ...
 */
final class Version20230226153322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, demande_id INT NOT NULL, prix_final DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_6EEAA67D80E95E18 (demande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, commentaire VARCHAR(255) NOT NULL, note INT NOT NULL, service_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE demandes (id INT AUTO_INCREMENT NOT NULL, service_id INT DEFAULT NULL, user_id INT NOT NULL, statut VARCHAR(255) NOT NULL, planed_date DATE NOT NULL, debut_time TIME NOT NULL, end_time TIME NOT NULL, new_planed_date DATE DEFAULT NULL, paiement TINYINT(1) DEFAULT NULL, INDEX IDX_BD940CBBED5CA9E6 (service_id), INDEX IDX_BD940CBBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE option_service (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(2555) NOT NULL, prix DOUBLE PRECISION NOT NULL, localisation VARCHAR(255) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, caracteristique VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', categorie VARCHAR(255) NOT NULL, INDEX IDX_E19D9AD2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service_option_service (service_id INT NOT NULL, option_service_id INT NOT NULL, INDEX IDX_FA0FD011ED5CA9E6 (service_id), INDEX IDX_FA0FD01135B1D6 (option_service_id), PRIMARY KEY(service_id, option_service_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, image_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D80E95E18 FOREIGN KEY (demande_id) REFERENCES demandes (id)');
        ...
        $this->addSql('ALTER TABLE service_option_service ADD CONSTRAINT FK_FA0FD011ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE service_option_service ADD CONSTRAINT FK_FA0FD01135B1D6 FOREIGN KEY (option_service_id) REFERENCES option_service (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE service_option_service DROP FOREIGN KEY FK_FA0FD011ED5CA9E6');
        $this->addSql('ALTER TABLE service_option_service DROP FOREIGN KEY FK_FA0FD01135B1D6');
        ...
        $this->addSql('DROP TABLE service_option_service');
