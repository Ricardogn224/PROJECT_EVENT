...
class __TwigTemplate_b2c48cd9526faff9fba47c4e49d8f6ff extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <a class=\"text-danger\" href=\"{{ path('app_evenement_index') }}\">Retourner</a>

    {{ include('evenement/_delete_form.html.twig') }}
{% endblock %}
", "evenement/edit.html.twig", "/home/betkom/Bureau/PROJECT_EVENT/templates/evenement/edit.html.twig");
    }
}
