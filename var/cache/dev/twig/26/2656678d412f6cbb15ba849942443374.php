...
class __TwigTemplate_40f7e1e51ff2c995da02f7d168838c90 extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul>
        <li class=\"edit-picture-user\">
            <a href=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_profile_edit_picture_user", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12), "id", [], "any", false, false, false, 12)]), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  128 => 23,  124 => 22,  118 => 19,  114 => 18,  110 => 17,  102 => 14,  97 => 12,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}espace personnel | {{ app.user.userIdentifier }}{% endblock %}
...
{% block body %}
    ...
    <ul>
        <li class=\"edit-picture-user\">
            <a href=\"{{ path('app_profile_edit_picture_user', {'id': app.user.id}) }}\">
                <i class=\"fa-regular fa-pen-to-square\"></i>
        ...
        <li>Prénom: <strong>{{ app.user.prenom }}</strong></li>
        <li>Email:  <strong>{{ app.user.email }}</strong></li>
    </ul>
    <div class=\"flex aic gap-15 jcc\">
        <a class=\"btn-default\" href=\"{{ path('app_service_account_index') }}\">Gestion de mes services proposés</a>
        <a class=\"btn-default\" href=\"{{ path('app_demandes_account_index') }}\">Gestion de mes demandes</a>
    </div>
...
{% endblock %}
", "profile/profile.html.twig", "/home/betkom/Bureau/PROJECT_EVENT/templates/profile/profile.html.twig");
    }
}
