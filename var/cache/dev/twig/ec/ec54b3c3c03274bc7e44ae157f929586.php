...
class __TwigTemplate_9da16334973b4a59af4d27f4894b84fe extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <h2>Modifer le service</h2>

    {{ include('service/_form.html.twig', {'button_label': 'Update'}) }}

    <a class=\"text-danger\" href=\"{{ path('app_service_index') }}\">Retourner</a>

    {{ include('service/_delete_form.html.twig') }}
{% endblock %}
", "service/edit.html.twig", "/home/betkom/Bureau/PROJECT_EVENT/templates/service/edit.html.twig");
    }
}
